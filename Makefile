...
$(objects): %.o: src/%.cpp
	...
	@echo Updating $^
link:
	@g++ *.o -o bin/debug/main -Llib -lSDL2main -lSDL2_ttf -lSDL2 -lSDL2_image -lSDL2_mixer -Wl,-rpath,lib -Wl,--disable-new-dtags -Wl,-dynamic-linker,lib/ld-linux-x86-64.so.2
run:
	@./bin/debug/main
